<?php
/*
This is some AI generated fuckery that magically works.
Soon enough I want to replace this with a basemap image generated by the server by location,
using the actual source basemap from the i1. Hex is dangling it infront of my face like usual.
for now since I am not the intellistar 1 god (hex), we use the mapbox map.
(back in my day hex wasn't a gatekeeping son of a bitch and was part of the 9DCrew)
*/
?>
<!DOCTYPE html>
<html>
